            ...
            <Container>
                <Flex fd="column" border='1px solid black'>
                    ...
                    <AuthForm onSubmit={onFormSubmit}>
                        ...
                        <input type="text" name="username" id="username" value={userDetails.username} onChange={onInputChange} placeholder="Username" pattern="[A-Za-z0-9{20}]" title="Numbers & letters only. 20 Character maximum" required></input>
